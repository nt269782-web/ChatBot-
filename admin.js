...
const API_BASE_URL = "https://chatbot-4-0iew.onrender.com";
    ...
    try {
        ...
        const url =
            editId === null
                ...
                : `${API_BASE_URL}/api/admin/update/${editId}`;
...
async function loadData() {
    ...
    try {
        ...
        if (!Array.isArray(data)) {
            throw new Error(
                "Server did not return a question list."
            );
        }
...
async function deleteData(id) {
    ...
    try {
        ...
        const response = await fetch(
            `${API_BASE_URL}/api/admin/delete/${id}`,
            {
                method: "DELETE"
            }
        );
